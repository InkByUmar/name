...
const MAPS: Record<string, string[]> = {
  ...
  // 𝘼𝙚𝙨𝙩𝙝𝙚𝙩𝙞𝙘 𝘽𝙤𝙡𝙙 𝙎𝙖𝙣𝙨
  boldItalicSans: Array.from("𝘼𝘽𝘾𝘿𝙀𝙁𝙂𝙃𝙄𝙅开𝙇𝙈𝙉𝙊婆𝙌𝙍𝙎𝙏𝙐𝙑𝙒𝙓𝙔𝙕𝙖𝙗𝙘搬𝙚𝙛𝙜𝙝𝙞𝙟𝙠𝙡𝙢𝙣𝙤辫𝙦𝙧𝙨𝙩𝙪𝙫𝙬𝙭𝙮𝙯0123456789"),
};

export type StyleCategory = 'all' | 'pubg' | 'freefire' | 'cod' | 'roblox' | 'minecraft';
export type LengthCategory = 'all' | 'short' | 'medium' | 'long';
...
export const STYLE_OPTIONS: StyleOption[] = [
  { id: 'none', name: 'Normal Text', category: ['all'], lengthCategory: 'short', transform: (t) => t },
  { id: 'bold', name: 'Elite Bold', category: ['all', 'pubg', 'cod'], lengthCategory: 'short', transform: mapTransform('bold') },
  { id: 'italic', name: 'Elite Italic', category: ['all', 'freefire'], lengthCategory: 'medium', transform: mapTransform('italic') },
  { id: 'boldItalic', name: 'Alpha Bold Italic', category: ['all', 'pubg'], lengthCategory: 'medium', transform: mapTransform('boldItalic') },
  { id: 'script', name: 'Royal Script', category: ['all', 'roblox'], lengthCategory: 'long', transform: mapTransform('script') },
  { id: 'boldScript', name: 'Pro Bold Script', category: ['all', 'pubg', 'cod'], lengthCategory: 'long', transform: mapTransform('boldScript') },
  { id: 'fraktur', name: 'Gothic Forge', category: ['all', 'pubg'], lengthCategory: 'medium', transform: mapTransform('fraktur') },
  { id: 'boldFraktur', name: 'Elite Fraktur', category: ['all', 'pubg', 'cod'], lengthCategory: 'medium', transform: mapTransform('boldFraktur') },
  { id: 'double', name: 'Double Struck', category: ['all', 'roblox'], lengthCategory: 'long', transform: mapTransform('doubleStruck') },
  { id: 'smallCaps', name: 'Small Caps', category: ['all', 'freefire'], lengthCategory: 'short', transform: mapTransform('smallCaps') },
  { id: 'aesthetic', name: 'Fullwidth Aesthetic', category: ['all', 'minecraft'], lengthCategory: 'long', transform: mapTransform('fullwidth') },
  { id: 'boldSans', name: 'Tactical Sans Bold', category: ['all', 'cod'], lengthCategory: 'short', transform: mapTransform('boldSans') },
  { id: 'monospace', name: 'Tactical Monospace', category: ['all', 'minecraft'], lengthCategory: 'long', transform: mapTransform('monospace') },
  { id: 'sans', name: 'Tactical Sans', category: ['all', 'roblox'], lengthCategory: 'medium', transform: mapTransform('sans') },
  { id: 'italicSans', name: 'Stealth Italic Sans', category: ['all', 'pubg'], lengthCategory: 'medium', transform: mapTransform('italicSans') },
  { id: 'boldItalicSans', name: 'Prime Bold Italic Sans', category: ['all', 'cod'], lengthCategory: 'medium', transform: mapTransform('boldItalicSans') },
];
...
for (let i = 0; i < 80; i++) {
  ...
  STYLE_OPTIONS.push({
    ...
    category: ['all'],
    lengthCategory: i % 3 === 0 ? 'short' : i % 3 === 1 ? 'medium' : 'long',
