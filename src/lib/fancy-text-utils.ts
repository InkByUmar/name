...
/**
 * MASSIVE VERIFIED GAMING SYMBOL ARSENAL
 * 500+ Stable Unicode symbols for high-end gaming compatibility.
 */
export const LEFT_SYMBOLS = [
  ...
  "♛", "♚", "♔", "♕", "♜", "♝", "♞", "♖", "✯", "✧", "✰", "✪", "✫", "✵", "•", "◥", "◤", "◣", "◢", "⚔", "⚒", "⚓", "⚖", "⚙", "⚛", "⚜", "⚝", "⚠", "⚡", "⚪", "⚫", "⚽", "⚾", "⛎", "⛏", "⛑", "⛓", "⛔", "⛩", "⛪", "⛰", "⛱", "⛲", "⛳", "⛴", "⛵", "⛺",
  // Cuneiform & Ancient
  "𒆞", "𒆟", "𒆠", "𒆡", "𒆢", " hospice", "𒆤", "𒆥", "ཌ", "ཋ", "࿇", "࿈", "࿉", "࿊", "࿋", "࿌", "࿍", "࿎", "࿏", "࿒", "࿓", "࿖", "࿗", "࿘", "࿙", "࿚",
  // Zodiac & Nature
  "☯", "☸", "♈", "♉", " Gemini", "♋", "♌", " Virgo", "♎", " Scorpio", "♐", " Capricorn", "♒", " Pisces", "☀", "☁", "☂", "☃", "☄", "☇", "☈", "☉", "☕", "☘", "☠", "☢", "☣", "☪", "☫", "☬", "☭", "☮", "☯",
  // Tech & Shapes
  "☐", "☑", "☒", "☓", "☖", "☗", "☕", "☘", "⚑", "⚒", "⚓", "⚔", "⚕", "⚖", "⚗", "⚘", "⚙", "⚚", "⚛", "⚜", "⚝", "⚠", "⚡", "⚪", "⚫", "⚽", "⚾", "⛎", "⛏", "⛑", "⛓", "⛔", "⛩", "⛪", "⛰", "⛱", "⛲", "⛳", "⛴", "⛵", "⛺",
  // Extra Wings & Symbols
  "ৡ", "ৢ", "ৣ", "৤", "৥", "০", "১", "২", "৩", "৪", "৫", "৬", "৭", "৮", "৯", "ৰ", "ৱ", "৲", "￳", "￻", "￼", "", "￾", "￿", "ﲼ", "ﳂ", "ﳉ", "ﳐ", "ﳗ", "ﳞ", "ﳥ", "ﳬ", "ﳳ", "ﳺ", "ﴁ", "ﴈ", "ﴏ", "ﴖ", "ﴝ", "ﴤ", "ﴫ", "ﴲ", "ﴹ", "﵀", "﵇", "﵎", "ﵕ", "ﵜ", "ﵣ", "ﵪ", "ﵱ", "ﵸ", "ﶏ", "ﶖ", "ﶝ", "ﶤ", "ﶫ", "ﶲ", "ﶹ", "ﷀ", "ﷇ", "﷎", "﷕", "﷜", "﷣", "﷪", "ﷱ", "ﷸ", "️", "︖", "︝", "︤", "︫", "︲", "︹"
];
