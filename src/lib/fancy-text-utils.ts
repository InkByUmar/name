...
const MAPS: Record<string, string[]> = {
  ...
  fraktur: "𝔄𝔅ℭ𝔇𝔈𝔉𝔊ℌℑ𝔍𝔎𝔏𝔐𝔑𝔒𝔓𝔔ℜ𝔖𝔗𝔘𝔙𝔚𝔛𝔜ℨ𝔞𝔟┠𝔡𝔢𝔣𝔫𝔥𝔦𝔧𝔨𝔩𝔪𝔫𝔬𝔭𝔮𝔯𝔰𝔱𝔲𝔳𝔴𝔵𝔶𝔷0123456789".split(""),
...
export const STYLE_OPTIONS: StyleOption[] = [
  { id: 'normal', name: 'Standard', category: ['all'], transform: (t) => t },
...
// Generate 50+ variations using stable mappings
