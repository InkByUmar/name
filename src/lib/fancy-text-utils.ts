...
const EMOJIS = [
  ...
  "⚽️", "🏀", "🏈", "⚾️", "🥎", "🎾", "🏐", "🏉", "🎱", "🏓", "🏸", "🥅", "🏒", "🏑", "🏏", "⛳️", "🏹", "🎣", "🤿", "🥊", "🥋", "⛸", "🎿", "🛷", "🎯", "🪀", "🪁", "🎰", "🎮", "🕹", "👾", "🔫", "🎲", "🧩", "🧸", "♟", "🃏", "🀄️", "🎨", "🧵", "🧶", "🎼", "🎤", "🎧", "🎷", "🎸", "🎹", "🎺", "🎻", "🥁", "🎬", "🎭", "🎟", "🎫",
  // Objects & Tools
  "⌚️", "📱", "📲", "💻", "⌨️", "🖱", "🖨", "🖲", "💾", "💿", "📀", "📼", "📷", "📸", "📹", "🎥", "📽", "🎞", "📞", "☎️", "📟", "📠", "📺", "📻", "🎙", "🎚", "🎛", "🧭", "⏱", "⏲", "⏰", "🕰", "⌛️", "⏳", "📡", "🔋", "🔌", "💡", "🔦", "🕯", "🪔", "🧯", "🛢", "💸", "💵", "💴", "💶", "💷", "💰", "💳", "💎", "⚖️", "🧰", "🔧", "🔨", "⚒", "🛠", "⛏", "🔩", "⚙️", "🧱", "⛓", "🧲", "🔫", "💣", "🧨", "🔪", "🗡", "⚔️", "🛡", "🚬", "⚰️", "⚱️", "🏺", "🔮", "🧿", "💈", "⚗️", " Telescope", "🔬", "🕳", "🩹", "🩺", "💊", "💉", "🩸", "🧬", "🌡", "🧹", "🧺", "🧻", "🚽", "🚰", "🚿", "🛀", "🧼", "🪒", "🧴", "🧷",
  // Symbols & Hearts
  "❤️", "🧡", "💛", "💚", "💙", "💜", "🖤", "🤍", "🤎", "💔", "❣️", "💕", "💞", "💓", "💗", "💖", "💘", "💝", "💟", "☮️", "✝️", "☪️", "🕉", "☸️", "🔯", "♈️", "♉️", " Gemini", "♋️", "♌️", " Virgo", "♎️", " Scorpio", "♐️", " Capricorn", "♒️", " Pisces", "⛎", "☯️", "☦️", "🛐", "⛎", "⚛️", "🕉", "☸️", "☯️", "✝️", "☦️", "☪️", "☮️", "🕎", "🔯", "♈️", "♉️", " Gemini", "♋️", "♌️", " Virgo", "♎️", " Scorpio", "♐️", " Capricorn", "♒️", " Pisces", "⛎", "⚧", "✖️", "➕", "➖", "➗", "♾", "‼️", "⁉️", "❓", "❔", "❕", "❗️", "〰️", "⚕️", "♻️", "⚜️", "🔱", "📛", "🔰", "⭕️", "✅", "☑️", "✔️", "❌", "❎", "➰", "➰", "〽️", "✳️", "✴️", "❇️", "©️", "®️", "™️",
  // Flags
