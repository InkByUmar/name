...
const MAPS: Record<string, string[]> = {
  ...
  // 𝑰𝒕𝒂𝒍𝒊𝒄 𝑺𝒆𝒓𝒊𝒇
  italic: "𝑨𝑩𝑪𝑫𝑬𝑭𝑮𝑯𝑰𝑲𝑳𝑴𝑵𝑶𝑷𝑸𝑹𝑺𝑻𝑼𝑽𝑾𝑿𝒀𝒁𝒂𝒃𝒄𝒅𝒆𝒇𝒈𝒉𝒊𝒋𝒌𝒍𝒎𝒏𝒐𝒑𝒒𝒓𝒔𝒕𝒖𝒗𝒘𝒙𝒚𝒛0123456789".split(""),
  // 𝑩𝒐𝒍𝒅 𝑰𝒕𝒂𝒍𝒊𝒄
  boldItalic: "𝑨𝑩𝑪𝑫𝑬𝑭𝑮𝑯𝑰𝐱𝑲𝑳𝑴𝑵𝑶𝑷𝑸𝑹𝑺𝑻𝑼𝑽𝑾𝑿𝒀𝒁𝒂𝒃𝒄𝒅𝒆𝒇𝒈𝒉𝒊𝒋𝒌𝒍𝒎𝒏𝒐𝒑𝒒𝒓𝒔𝒕𝒖𝒗𝒘𝒙𝒚𝒛0123456789".split(""),
...
export const LEFT_SYMBOLS = [
  "ツ", "亗", "彡", "乡", "私", "乂", "༒", "꧁", "『", "么", "〆", "シ", "卍", "★", "☆", "✦", "༺", "𒆜", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu",
  "☬", "×", "๛", "۝", "ঔৣ", "乛", "乄", "īlī", "ム", "の", "王", "丶", "ズ", "刁", "Ø", "ジ", "ɧ", "く", "乇", "ゞ", "「", "文", "《", "爪", "ʚ", "气", "Ð", "个", "연", "乙", "๖", "ム", "卄", "米", "〖", "⦇", "冬", "れ", "【", "多", "々", "乀", "〘", "丨", "廴", "一", "父", "神", "人", "帝", "レ", "ｱ", "ロ", "요", "厄", "ภ", "≋", "义", "サ", "ハ", "ク", "ほ", "バ", "グ", "ぼ", "ぇ", "パ", "ケ", "ぽ", "♛", "♚", "♔", "♕", "♜", "♝", "♞", "♖", "✯", "✧", "✰", "✪", "✫", "✵", "•", "◥", "◣", "〆", "๛", "气", "๖", "ム", "乇", "𒆞", "𒆟", "𒆠", "𒆡", "𒆢", "𒆣", "𒆤", "𒆥", "ཌ", "ཋ", "༄", "᭄", "࿐", "乄", "〆", "シ", "卍", "✪", "❂", "❈", "❉", "❊", "❋", "❅", "❆", "♡", "❥", "❦", "❧", "ღ", "༒", "༼", "༾", "࿔", "࿕", "࿖", "࿗", "࿘", "࿙",
  "☯", "☸", "♈", "♉", " Gemini", "♋", "♌", "♍", "♎", "♏", "♐", "♑", "♒", "♓", "☀", "☁", "☂", "☃", "☄", "☇", "☈", "☉", "☊", "☋", "☌", "☍", "☎", "☏", "☐", "☑", "☒", "☓", "☖", "☗", "☕", "☘", "☙", "☚", "☛", "☜", "☝", "☞", "☟", "☠", "☡", "☢", "☣", "☤", "☥", "☦", "☧", "☨", "☩", "☪", "☫", "☬", "☭", "☮", "☯", "☰", "☱", "☲", "☳", "☴", "☵", "☶", "☷", "☸", "☹", "☺", "☻", "☼", "☽", "☾", "☿", "♀", "♁", "♂", "♃", "♄", "♅", "♆", "♇", "♈", "♉", "♊", "♋", "♌", "♍", "♎", "♏", "♐", "♑", "♒", "♓", "♔", "♕", "♖", "♗", "♘", "♙", "♚", "♛", "♜", "♝", "♞", "♟", "♠", "♡", "♢", "♣", "♤", "♥", "♦", "♧", "♨", "♩", "♪", "♫", "♬", "♭", "♮", "♯", "♰", "♱", "♲", "♳", "♴", "♵", "♶", "♷", "♸", "♹", "♺", "♻", "♼", "♽", "♾", "♿", "⚀", "⚁", "⚂", "⚃", "⚄", "⚅", "⚆", "⚇", "⚈", "⚉", "⚊", "⚋", "⚌", "⚍", "⚎", "⚏", "⚐", "⚑", "⚒", "⚓", "⚔", "⚕", "⚖", "⚗", "⚘", "⚙", "⚚", "⚛", "⚜", "⚝", "⚞", "⚠", "⚡", "⚢", "⚣", "⚤", "⚥", "⚦", "⚧", "⚨", "⚩", "⚪", "⚫", "⚬", "⚭", "⚮", "⚯", "⚰", "⚱", "⚲", "⚳", "⚴", "⚵", "⚶", "⚷", "⚸", "⚹", "⚺", "⚻", "⚼", "⚽", "⚾", "⚿", "⛀", "⛁", "⛂", "⛃", "⛄", "⛅", "⛈", "⛎", "⛏", "⛑", "⛓", "⛔", "⛕", "⛖", "⛗", "⛘", "⛙", "⛚", "⛛", "⛜", "⛝", "⛞", "⛟", "⛠", "⛡", "⛢", "⛣", "⛤", "⛥", "⛦", "⛧", "⛨", "⛩", "⛪", "⛫", "⛬", "⛭", "⛮", "⛯", "⛰", "⛱", "⛲", "⛳", "⛴", "⛵", "⛷", "⛸", "⛹", "⛺", "⛻", "⛼", "⛽", "⛾", "⛿"
];

export const RIGHT_SYMBOLS = [
  "ツ", "亗", "彡", "乡", "私", "乂", "༒", "꧂", "』", "么", "〆", "シ", "卍", "★", "☆", "✦", "༻", "𒆜", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu", " bhikkhu",
  "☬", "×", "๛", "۝", "ঔৣ", "乛", "乄", "īlī", "ム", "の", "王", "丶", "ズ", "刁", "Ø", "ジ", "ɧ", "く", "乇", "ゞ", "」", "文", "》", "爪", "ʚ", "气", "Ð", "个", "연", "乙", "๖", "ム", "卄", "米", "〗", "⦈", "冬", "れ", "】", "多", "々", "乀", "〙", "丨", "廴", "一", "父", "神", "人", "帝", "レ", "ｱ", "ロ", "요", "厄", "ภ", "≋", "义", "サ", "ハ", "ク", "ほ", "バ", "グ", "ぼ", "ぇ", "パ", "ケ", "ぽ", "♛", "♚", "♔", "♕", "♜", "♝", "♞", "♖", "✯", "✧", "✰", "✪", "✫", "✵", "•", "◤", "◢", "〆", "๛", "气", "๖", "ム", "乇", "𒆞", "𒆟", "𒆠", "𒆡", "𒆢", "𒆣", "𒆤", "𒆥", "ཌ", "ཋ", "꧂", "༄", "᭄", "࿐", "乄", "〆", "シ", "卍", "✪", "❂", "❈", "❉", "❊", "❋", "❅", "❆", "♡", "❥", "❦", "❧", "ღ", "༒", "༽", "༿", "࿔", "࿕", "࿖", "࿗", "࿘", "࿙",
  "➔", "➘", "➙", "➚", "➛", "➜", "➝", "➞", "➟", "➠", "➡", "➢", "➣", "➤", "➥", "➦", "➧", "➨", "➲", "➳", "➴", "➵", "➶", "➷", "➸", "➹", "➺", "➻", "➼", "➽", "➾", "⟁", "⟂", "⟃", "⟄", "⟅", "⟆", "⟇", "⟈", "⟉", "⟊", "⟋", "⟌", "⟍", "⟎", "⟏", "⟐", "⟑", "⟒", "⟓", "⟔", "⟕", "⟖", "⟗", "⟘", "⟙", "⟚", "⟛", "⟜", "⟝", "⟞", "⟟", "⟠", "⟡", "⟢", "⟣", "⟤", "⟥", "⟦", "⟧", "⟨", "⟩", "⟪", "⟫", "⟬", "⟭", "⟮", "⟯", "⟰", "⟱", "⟲", "⟳", "⟴", "⟵", "⟶", "⟷", "⟸", "⟹", "⟺", "⟻", "⟼", "⟽", "⟾", "⟿", "⤀", "⤁", "⤂", "⤃", "⤄", "⤅", "⤆", "⤇", "⤈", "⤉", "⤊", "⤋", "⤌", "⤍", "⤎", "⤏", "⤐", "⤑", "⤒", "⤓", "⤔", "⤕", "⤖", "⤗", "⤘", "⤙", "⤚", "⤛", "⤜", "⤝", "⤞", "⤟", "⤠", "⤡", "⤢", "⤣", "⤤", "⤥", "⤦", "⤧", "⤨", "⤩", "⤪", "⤫", "⤬", "⤭", "⤮", "⤯", "⤰", "⤱", "⤲", "⤳", "⤴", "⤵", "⤶", "⤷", "⤸", "⤹", "⤺", "⤻", "⤼", "⤽", "⤾", "⤿", "⥀", "⥁", "⥂", "⥃", "⥄", "⥅", "⥆", "⥇", "⥈", "⥉", "⥊", "⥋", "⥌", "⥍", "⥎", "⥏", "⥐", "⥑", "⥒", "⥓", "⥔", "⥕", "⥖", "⥗", "⥘", "⥙", "⥚", "⥛", "⥜", "⥝", "⥞", "⥟", "⥠", "⥡", "⥢", "⥣", "⥤", "⥥", "⥦", "⥧", "⥨", "⥩", "⥪", "⥫", "⥬", "⥭", "⥮", "⥯", "⥰", "⥱", "⥲", "⥳", "⥴", "⥵", "⥶", "⥷", "⥸", "⥹", "⥺", "⥻", "⥼", "⥽", "⥾", "⥿"
];
